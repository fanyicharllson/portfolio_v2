  ...
  useEffect(() => {
    ...
    class Particle {
      ...
      update() {
        ...
        if (
          (canvas && this.x > canvas.width / devicePixelRatio) ||
          this.x < 0
        ) {
        ...
        if (
          (canvas && this.y > canvas.height / devicePixelRatio) ||
          this.y < 0
        ) {
    ...
    for (let i = 0; i < particleCount; i++) {
      particlesArray.push(
        new Particle(canvas.width, canvas.height, window.devicePixelRatio || 1)
      );
    }
